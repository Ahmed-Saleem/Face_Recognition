...
def main():
    ...
    output_without_audio_path = "output_videos/output_without_audio_Arif_Alvi2.mp4"
    audio_path = "output_videos/audio_Arif_Alvi2.aac"
    ...
    # Add frame interval
    frame_interval = int(output_fps/6)
