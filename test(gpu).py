...
def main():
    ...
    input_path = "test_kenya/ruto2.mp4"
    output_without_audio_path = "output_videos/output_without_audio_ruto2.mp4"
    audio_path = "output_videos/audio_ruto2.mp3"
    output_path = "output_videos/output_ruto2.mp4"
    # scale_factor = 0.5
    ...
    while cap.isOpened():
        ...
        # if time_difference > 0.0001:  # Adjust this threshold as needed
